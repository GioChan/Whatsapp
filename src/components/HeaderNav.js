...
const StyledNavItem = styled.a`
  ...
  border-bottom: ${(props) => (props.viewState === props.current ? '3px solid white' : 'none')};
  &:active {
...
const HeaderNav = ({ changeViewState, viewState }: Props) => {
  return (
    <StyledHeaderNav>
      <StyledNavItem data-nav="1" onClick={changeViewState} viewState={viewState} current="1">
      ...
      <StyledNavItem data-nav="2" onClick={changeViewState} viewState={viewState} current="2">
        CHATS
      </StyledNavItem>
      <StyledNavItem data-nav="3" onClick={changeViewState} viewState={viewState} current="3">
        STATUS
      </StyledNavItem>
      <StyledNavItem data-nav="4" onClick={changeViewState} viewState={viewState} current="4">
        CALLS
      </StyledNavItem>
    </StyledHeaderNav>
  );
